...
2. hev1fix - WebOS Chromium Tag fix, if the codec tag is hev1, it fixes it by copying the file and setting the codec tag to hvc1 for the stream. JellyFin on WebOS is a b*tch about this.
